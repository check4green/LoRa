...
String outgoingSensorAddress = "3411537a00";
...
//    int temperature = sensors.getTempCByIndex(0);
    String senVal = String(20);   // send a message
    sendMessage(flagAddress, senVal);
...
void sendMessage(String flagAddress, String sensorValue) {
